...
import py2exe, sys, os, decimal, json, tkinter.filedialog, tkinter.font, tkinter.messagebox, tkinter as tk, libs.scrollableFrame, re, libs.num2t4ru, datetime, i18n, parsers.docx, parsers.xlsx
